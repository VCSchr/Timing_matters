...
k_CI$treatment <- gsub("transplant", "trans.", k_CI$treatment)


# for indication of significance
ann_text_1 <- data.frame(treatment = "trans.", k.mean = 0.003, lab = "\U25AA", 
                       time.point = factor("April",levels = c("April", "June", "August", "September")))  
# Difference forest - viti April
ann_text_2 <- data.frame(treatment = "viti", k.mean = 0.002885, lab = "\U25AA", 
                       time.point = factor("April",levels = c("April", "June", "August", "September"))) 
# Difference transplant - viti April
# ann_text_3 <- data.frame(treatment = "trans.", k.mean = 0.20, lab = "\U25AA",  # unicode hex for square
#                        time.point = factor("June",levels = c("April", "June", "August", "September"))) 
# # Difference forest - viti June
ann_text_4 <- data.frame(treatment = "viti", k.mean = 0.00288, lab = "**", 
                       time.point = factor("June",levels = c("April", "June", "August", "September"))) 
# Difference transplant - viti June
# ann_text_5 <- data.frame(treatment = "forest", k.mean = 0.195, lab = "\U25AA", 
#                        time.point = factor("August",levels = c("April", "June", "August", "September"))) 
# # Difference forest - transplant August
ann_text_6 <- data.frame(treatment = "trans.", k.mean = 0.00299, lab = "***", 
                       time.point = factor("August",levels = c("April", "June", "August", "September"))) 
# Difference forest - viti August
ann_text_7 <- data.frame(treatment = "viti", k.mean = 0.00288, lab = "***", 
                       time.point = factor("August",levels = c("April", "June", "August", "September"))) 
# Difference transplant - viti August
# ann_text_8 <- data.frame(treatment = "forest", k.mean = 0.1945, lab = "*", 
#                        time.point = factor("September",levels = c("April", "June", "August", "September"))) 
# # Difference forest - transplant September
ann_text_9 <- data.frame(treatment = "trans.", k.mean = 0.00299, lab = "**", 
                       time.point = factor("September",levels = c("April", "June", "August", "September"))) 
# Difference forest - viti September
# ann_text_10 <- data.frame(treatment = "viti", k.mean = 0.195, lab = "\U25AA",
#                        time.point = factor("September",levels = c("April", "June", "August", "September"))) 
...
svg(filename="Figure_1_k.svg", width=10, height=7.5, pointsize=12)
p1_k
dev.off()
...
# rename transplant treatments in order to enable fit to the plot
spor_CI$treatment <- gsub("transplant", "trans.", spor_CI$treatment)
...
# svg(filename="Figure_SX_sporulation_rate.svg", width=10, height=7.5, pointsize=12)
png(filename="Figure_SX_sporulation_rate.png", width=10, height=7.5, pointsize=12, units = "in", res = 800)
p1_spor
dev.off()
```
...
##### create Plot similar to Figure 2 without ploygons
```{r}
scl = 'symmetric'
# arrange size of single plot
si_sc <- scores(rda_conid_5, choices = 1:2, scaling = scl, display = 'sites')
...
png(filename="Figure_SX_RDA_conidia_wo_polygon.png", width=15, height=15, pointsize=10, units = "cm", res = 800)
p1_RDA_conid <- plot(rda_conid_5, 
          scaling = 'symmetric', 
          type = 'n',
          xlab = 
...
```{r}
fig_S4_richness <-ggarrange(p1_taxa, p1_tax_DNA, p1_ASV_hyph, p1_ASV, nrow = 2, ncol= 2, labels = c("A","B", "C", "D"))


svg(filename="Figure_S4_richness.svg", width=16.5, height=15, pointsize=11)
fig_S4_richness
dev.off()
